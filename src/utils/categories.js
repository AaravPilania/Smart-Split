export const CATEGORIES = [
  ...
  { key: "subscriptions", label: "Subscriptions",    icon: "🔄", badge: "bg-violet-100 text-violet-700 dark:bg-violet-900/40 dark:text-violet-300" },
...
const KEYWORDS = {
  ...
  entertainment: ["movie","game","party","concert","event","ticket","show","bowling","cinema","night out","gaming","playstation","xbox","steam","imax","pvr","inox","cinepolis","multiplex","carnival","amusement","theme park","waterpark","museum","theatre","theater","drama","stand up","comedy","standup","karaoke","nightclub","lounge","arcade","birthday","anniversary","celebration","festival","diwali","holi","christmas","picnic","outing","hangout","escape room","paintball","trampoline"],
  ...
  subscriptions: ["subscription","netflix","spotify","prime","hotstar","disney","jiocinema","zee5","sonyliv","youtube premium","apple music","apple tv","hbo","crunchyroll","amazon prime","prime video","monthly","recurring","renewal","annual plan","icloud","google one","dropbox","notion","canva","chatgpt","openai","github","adobe","figma","microsoft 365","office 365","xbox game pass","ps plus","playstation plus","nintendo","vpn","nordvpn","expressvpn","surfshark","audible","kindle unlimited","medium","substack","patreon","twitch","linkedin premium","grammarly","duolingo","headspace","calm","strava","peloton","masterclass","skillshare","coursera","udemy"],
};
